 ...
 */
public class AddEmp extends javax.swing.JInternalFrame implements UIInterface {
    ...
    public void initUI() {
        enableButton(false);
        showPanel("List Staff",updatePanel,listPanel,detailPanel);
...
//        newStaff.setBirthday(entity.parseDate(txtBirthday.getText()));
    ...
    private void initComponents() {
        ...
        setBorder(null);
        setFrameIcon(null);
        setMinimumSize(new java.awt.Dimension(1025, 720));
        setName(""); // NOI18N
        ...
        detailPanel.setBackground(new java.awt.Color(45, 129, 171));
        detailPanel.setMinimumSize(new java.awt.Dimension(1020, 700));
        detailPanel.setName(""); // NOI18N
        ...
        jScrollPane2.setBackground(new java.awt.Color(45, 129, 171));
        jScrollPane2.setBorder(null);
        jScrollPane2.setMaximumSize(new java.awt.Dimension(1020, 710));
        jScrollPane2.setMinimumSize(new java.awt.Dimension(1020, 710));
        jScrollPane2.setName(""); // NOI18N
        jScrollPane2.setPreferredSize(new java.awt.Dimension(1020, 710));

        detailPaneld.setBackground(new java.awt.Color(45, 129, 171));
        detailPaneld.setMaximumSize(new java.awt.Dimension(1020, 1120));
        detailPaneld.setMinimumSize(new java.awt.Dimension(1020, 1120));
        detailPaneld.setName(""); // NOI18N
        detailPaneld.setPreferredSize(new java.awt.Dimension(1020, 1120));
        ...
        detailPaneld.add(jLabel45, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 470, 760, 25));
        ...
        detailPaneld.add(jLabel46, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 350, 760, 25));
        ...
        detailPaneld.add(jLabel50, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 650, 760, 25));
        ...
        jLabel31.setBackground(new java.awt.Color(52, 203, 0));
        jLabel31.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel31.setForeground(new java.awt.Color(255, 255, 255));
        jLabel31.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel31.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Browse_Folder_18px.png"))); // NOI18N
        jLabel31.setText("Browse");
        ...
        detailPanel.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1012, 710));
        ...
        jScrollPane7.setMaximumSize(new java.awt.Dimension(1020, 710));
        jScrollPane7.setMinimumSize(new java.awt.Dimension(1020, 710));
        jScrollPane7.setPreferredSize(new java.awt.Dimension(1020, 710));
        jScrollPane7.setRequestFocusEnabled(false);

        cont.setBackground(new java.awt.Color(45, 129, 171));
        cont.setMaximumSize(new java.awt.Dimension(1020, 1120));
        cont.setMinimumSize(new java.awt.Dimension(1020, 1120));
        cont.setName(""); // NOI18N
        cont.setPreferredSize(new java.awt.Dimension(1020, 1120));
        ...
        labelAction.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Employee_30px.png"))); // NOI18N
        labelAction.setText("Add Employee  Details");
        ...
        updatePanel.add(jScrollPane7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1012, 710));
...
//        currentStaff = entity.getDetailStaff(entity.getSelectID(tblStaff));
    ...
    private void jLabel11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel11MouseClicked
       act = ADD;
        newStaff = new Staff();
        showPanel("Add Staff", updatePanel,listPanel,detailPanel);
    ...
    private void btnEditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditMouseClicked
     act = EDIT;
        ...
        newStaff = currentStaff;
        loadEdit();
        showPanel("Edit Staff", updatePanel,listPanel,detailPanel);           // TODO add your handling code here:
 ...
 deactive();               // TODO add your handling code here:
    ...
    private void btnDetailMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDetailMouseClicked
     act = DETAIL;
        currentStaff = entity.findByID(entity.getSelectID(tblStaff));
        showPanel("Staff Detail",detailPanel,listPanel,updatePanel);
    ...
    private void btnViewListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnViewListMouseClicked
       showPanel("List Staff", listPanel,listPanel,updatePanel);  // TODO add your handling code here:
   ...
   loadPromotionInfo(EDIT);     // TODO add your handling code here:
    ...
    newStaff = null;
        showPanel("List Staff", listPanel,updatePanel,detailPanel);    // TODO add your handling code here:
