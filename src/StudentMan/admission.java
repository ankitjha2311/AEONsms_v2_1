 ...
 */
public class admission extends javax.swing.JInternalFrame implements UIInterface{
    ...
    public void initUI(){
        enableButton(false);
        showPanel("List Student",updatePanel, listPanel,detailPanel);
    ...
    private void initComponents() {
        ...
        btnDeactive1 = new javax.swing.JLabel();
        jLabel28 = new javax.swing.JLabel();
        labelEmail1 = new javax.swing.JLabel();
        btnExtraDetail = new javax.swing.JLabel();
        jLabel29 = new javax.swing.JLabel();
        btnRemarkDetail = new javax.swing.JLabel();
        btnRelationDetail = new javax.swing.JLabel();
        ...
        updatePanel.setMinimumSize(new java.awt.Dimension(1020, 700));
        updatePanel.setPreferredSize(new java.awt.Dimension(1020, 700));

        can.setBackground(new java.awt.Color(45, 129, 171));
        ...
        can.add(txtNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 240, 180, 25));

        can.add(comboBatch, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 210, 180, 25));
        ...
        can.add(jLabel40, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 240, 90, 25));
        ...
        can.add(jLabel42, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 210, 90, 25));

        txtName.setBackground(new java.awt.Color(85, 153, 187));
        txtName.setBorder(null);
        can.add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 150, 200, 25));
        ...
        can.add(jLabel43, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 150, 88, 25));
        ...
        can.add(jLabel51, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 240, 88, 25));

        txtEmail.setBackground(new java.awt.Color(85, 153, 187));
        txtEmail.setBorder(null);
        can.add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 240, 200, 25));
        ...
        can.add(jLabel52, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 270, 90, 25));
        ...
        can.add(jScrollPane6, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 380, 670, 90));
        ...
        can.add(jLabel53, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 180, 90, 25));
        ...
        can.add(jLabel54, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 180, 88, 25));
        ...
        tblMark.setSelectionBackground(new java.awt.Color(0, 153, 102));
        tblMark.setShowHorizontalLines(false);
        ...
        can.add(comboGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 180, 200, 25));

        labelUpdate.setBackground(new java.awt.Color(0, 102, 153));
        labelUpdate.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        ...
        labelUpdate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Student_Male_38px.png"))); // NOI18N
        labelUpdate.setText("Student Addmission");
        labelUpdate.setIconTextGap(20);
        labelUpdate.setOpaque(true);
        can.add(labelUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1030, 60));
        ...
        tblRelation.setSelectionBackground(new java.awt.Color(0, 153, 102));
        tblRelation.setShowHorizontalLines(false);
        ...
        can.add(jLabel60, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 300, 90, 25));
        ...
        can.add(jLabel61, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 330, 90, 25));
        ...
        can.add(jLabel62, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 270, 88, 25));

        txtPrevInstituteEdit.setBackground(new java.awt.Color(85, 153, 187));
        txtPrevInstituteEdit.setBorder(null);
        can.add(txtPrevInstituteEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 300, 495, 25));

        txtReasonLeavingEdit.setBackground(new java.awt.Color(85, 153, 187));
        txtReasonLeavingEdit.setBorder(null);
        can.add(txtReasonLeavingEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 330, 495, 25));
        ...
        tblRemark.setSelectionBackground(new java.awt.Color(0, 153, 102));
        tblRemark.setShowHorizontalLines(false);
        tblRemark.setShowVerticalLines(false);
        ...
        can.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 380, 90, 90));

        txtPhone.setBackground(new java.awt.Color(85, 153, 187));
        txtPhone.setBorder(null);
        can.add(txtPhone, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 270, 180, 25));
        ...
        tblExtraCurricular.setSelectionBackground(new java.awt.Color(0, 153, 102));
        ...
        can.add(jLabel44, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 150, 90, 25));

        txtRegisterNo.setEditable(false);
        txtRegisterNo.setBackground(new java.awt.Color(85, 153, 187));
        txtRegisterNo.setBorder(null);
        can.add(txtRegisterNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 150, 180, 25));
        can.add(dPic, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 180, 180, 25));
        can.add(admiDPic, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 270, 200, 25));

        comboBatch1.setBackground(new java.awt.Color(85, 153, 187));
        comboBatch1.setBorder(null);
        can.add(comboBatch1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 210, 200, 25));
        ...
        can.add(jLabel45, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 210, 88, 25));

        jLabel46.setBackground(new java.awt.Color(187, 237, 170));
        jLabel46.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel46.setOpaque(true);
        can.add(jLabel46, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 150, 140, 180));

        jLabel47.setBackground(new java.awt.Color(52, 203, 0));
        jLabel47.setForeground(new java.awt.Color(255, 255, 255));
        jLabel47.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel47.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Browse_Folder_18px.png"))); // NOI18N
        jLabel47.setText("Browse");
        jLabel47.setOpaque(true);
        can.add(jLabel47, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 330, 140, 25));
        ...
        getContentPane().add(updatePanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1020, 700));

        listPanel.setBackground(new java.awt.Color(45, 129, 171));
        listPanel.setMinimumSize(new java.awt.Dimension(1020, 700));
        listPanel.setPreferredSize(new java.awt.Dimension(1020, 700));
        ...
        tblStudent.setBackground(new java.awt.Color(4, 74, 121));
        ...
        listPanel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 190, 733, 285));
        ...
        listPanel.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 120, 90, 25));
        ...
        listPanel.add(jLabel64, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 150, 90, 25));
        ...
        listPanel.add(jLabel65, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 120, 90, 25));

        jLabel66.setBackground(new java.awt.Color(255, 102, 0));
        jLabel66.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel66.setForeground(new java.awt.Color(255, 255, 255));
        jLabel66.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel66.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Google_Web_Search_17px.png"))); // NOI18N
        ...
        listPanel.add(jLabel66, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 120, 90, 25));
        ...
        listPanel.add(txtRegisterNoSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 120, 200, 25));
        ...
        listPanel.add(txtNoSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 150, 200, 25));
        ...
        listPanel.add(txtNameSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 120, 170, 25));

        comboBatchSearch.setBackground(new java.awt.Color(85, 153, 187));
        comboBatchSearch.setEditable(true);
        comboBatchSearch.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        comboBatchSearch.setBorder(null);
        listPanel.add(comboBatchSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 150, 170, 25));
        ...
        listPanel.add(jLabel68, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 150, 90, 25));

        jLabel69.setBackground(new java.awt.Color(0, 102, 255));
        jLabel69.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel69.setForeground(new java.awt.Color(255, 255, 255));
        jLabel69.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel69.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Refresh_17px.png"))); // NOI18N
        ...
        listPanel.add(jLabel69, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 150, 90, 25));

        jLabel70.setBackground(new java.awt.Color(52, 203, 0));
        jLabel70.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel70.setForeground(new java.awt.Color(255, 255, 255));
        jLabel70.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel70.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Add_New_17px.png"))); // NOI18N
        ...
        listPanel.add(jLabel70, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 530, 90, 25));

        btnEdit1.setBackground(new java.awt.Color(204, 0, 204));
        ...
        btnEdit1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Edit_Row_17px.png"))); // NOI18N
        ...
        listPanel.add(btnEdit1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 530, 90, 25));
        ...
        listPanel.add(btnExport, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 530, 90, 25));

        btnDetail.setBackground(new java.awt.Color(255, 0, 102));
        ...
        btnDetail.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Info_18px_1.png"))); // NOI18N
        ...
        listPanel.add(btnDetail, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 530, 90, 25));
        ...
        listPanel.add(btnDeactive, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 530, 100, 25));

        getContentPane().add(listPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1020, 700));

        detailPanel.setMinimumSize(new java.awt.Dimension(1020, 700));
        detailPanel.setPreferredSize(new java.awt.Dimension(1020, 700));
        detailPanel.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jPanel1.setBackground(new java.awt.Color(45, 129, 171));
        jPanel1.setForeground(new java.awt.Color(4, 74, 121));
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 170, 120, 26));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 230, 120, 26));
        ...
        jPanel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 170, 120, 26));
        ...
        jPanel1.add(jLabel39, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 440, 680, 26));
        ...
        jPanel1.add(labelReasonLeaving, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 290, 660, 50));
        ...
        jPanel1.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 140, 120, 26));
        ...
        jPanel1.add(labelNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 140, 280, 26));
        ...
        jPanel1.add(labelBirthday, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 200, 240, 26));
        ...
        jPanel1.add(labelPhone, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 230, 280, 26));
        ...
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 770, 690, 26));
        ...
        jPanel1.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 290, 120, 50));
        ...
        jPanel1.add(labelRegisterNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 140, 240, 26));

        jScrollPane10.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(4, 74, 121)));

        tblMarkDetail3.setBackground(new java.awt.Color(4, 74, 121));
        tblMarkDetail3.setForeground(new java.awt.Color(255, 255, 255));
        ...
        tblMarkDetail3.setSelectionBackground(new java.awt.Color(0, 204, 51));
        tblMarkDetail3.setShowHorizontalLines(false);
        tblMarkDetail3.setShowVerticalLines(false);
        jScrollPane10.setViewportView(tblMarkDetail3);

        jPanel1.add(jScrollPane10, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 960, 780, 140));
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 200, 120, 26));

        jLabel1.setBackground(new java.awt.Color(0, 102, 153));
        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Student_Male_38px.png"))); // NOI18N
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 230, 120, 26));

        jScrollPane18.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(4, 74, 121)));

        tblRemarkDetail.setBackground(new java.awt.Color(4, 74, 121));
        tblRemarkDetail.setForeground(new java.awt.Color(255, 255, 255));
        ...
        tblRemarkDetail.setSelectionBackground(new java.awt.Color(0, 204, 51));
        tblRemarkDetail.setShowHorizontalLines(false);
        tblRemarkDetail.setShowVerticalLines(false);
        ...
        jPanel1.add(jScrollPane18, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 630, 780, 120));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 140, 120, 26));
        ...
        jPanel1.add(labelName, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 170, 240, 26));
        ...
        jPanel1.add(labelAdmissionTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 260, 280, 26));
        ...
        jPanel1.add(labelBatch, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 200, 280, 26));
        ...
        jPanel1.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 200, 120, 26));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 350, 660, 80));
        ...
        jPanel1.add(labelPrevInstitute, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 260, 240, 26));

        jScrollPane17.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(4, 74, 121)));

        tblRelationDetail.setBackground(new java.awt.Color(4, 74, 121));
        ...
        tblRelationDetail.setSelectionBackground(new java.awt.Color(0, 204, 51));
        tblRelationDetail.setShowHorizontalLines(false);
        tblRelationDetail.setShowVerticalLines(false);
        ...
        jPanel1.add(jScrollPane17, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 800, 780, 110));

        jScrollPane9.setBackground(new java.awt.Color(0, 102, 153));
        jScrollPane9.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(4, 74, 121)));

        tblExtraCurricularDetail.setBackground(new java.awt.Color(4, 74, 121));
        tblExtraCurricularDetail.setForeground(new java.awt.Color(255, 255, 255));
        ...
        tblExtraCurricularDetail.setSelectionBackground(new java.awt.Color(0, 204, 51));
        tblExtraCurricularDetail.setShowHorizontalLines(false);
        tblExtraCurricularDetail.setShowVerticalLines(false);
        jScrollPane9.setViewportView(tblExtraCurricularDetail);

        jPanel1.add(jScrollPane9, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 470, 780, 120));
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 350, 120, 80));
        ...
        jPanel1.add(labelGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 170, 280, 26));
        ...
        jPanel1.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 600, 680, 26));

        btnDeactive1.setBackground(new java.awt.Color(255, 0, 0));
        btnDeactive1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnDeactive1.setForeground(new java.awt.Color(255, 255, 255));
        btnDeactive1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        btnDeactive1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Radio_Active_17px.png"))); // NOI18N
        btnDeactive1.setText("Suspend");
        btnDeactive1.setOpaque(true);
        btnDeactive1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnDeactive1MouseClicked(evt);
            }
        });
        jPanel1.add(btnDeactive1, new org.netbeans.lib.awtextra.AbsoluteConstraints(847, 1120, 90, 25));
        ...
        jPanel1.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 260, 120, 26));
        ...
        jPanel1.add(labelEmail1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 230, 240, 26));

        btnExtraDetail.setBackground(new java.awt.Color(52, 203, 0));
        btnExtraDetail.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnExtraDetail.setForeground(new java.awt.Color(255, 255, 255));
        btnExtraDetail.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ...
        btnExtraDetail.setOpaque(true);
        btnExtraDetail.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnExtraDetailMouseClicked(evt);
            }
        });
        jPanel1.add(btnExtraDetail, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 440, 100, 26));
        ...
        jPanel1.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 260, 120, 26));

        btnRemarkDetail.setBackground(new java.awt.Color(52, 203, 0));
        btnRemarkDetail.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnRemarkDetail.setForeground(new java.awt.Color(255, 255, 255));
        btnRemarkDetail.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ...
        btnRemarkDetail.setOpaque(true);
        btnRemarkDetail.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnRemarkDetailMouseClicked(evt);
            }
        });
        jPanel1.add(btnRemarkDetail, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 600, 100, 26));

        btnRelationDetail.setBackground(new java.awt.Color(52, 203, 0));
        ...
        btnRelationDetail.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ...
        btnRelationDetail.setOpaque(true);
        btnRelationDetail.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnRelationDetailMouseClicked(evt);
            }
        });
        jPanel1.add(btnRelationDetail, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 770, 90, 26));

        jLabel48.setBackground(new java.awt.Color(0, 102, 153));
        jLabel48.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel48.setForeground(new java.awt.Color(255, 255, 255));
        jLabel48.setText("Mark");
        jLabel48.setOpaque(true);
        jPanel1.add(jLabel48, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 920, 780, 30));

        btnViewList.setBackground(new java.awt.Color(52, 203, 0));
        btnViewList.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        btnViewList.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Arrow_Pointing_Left_18px_1.png"))); // NOI18N
        ...
        jPanel1.add(btnViewList, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 1120, 77, 25));

        btnAdd.setBackground(new java.awt.Color(43, 175, 0));
        ...
        jPanel1.add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 1120, 77, 25));
        ...
        jPanel1.add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 1120, 77, 25));

        jScrollPane3.setViewportView(jPanel1);

        detailPanel.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1004, 670));

        getContentPane().add(detailPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1020, 700));
...
loadExtraInfo(ADD);        // TODO add your handling code here:
    ...
    private void btnExtraDetailMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnExtraDetailMouseClicked
       loadExtraInfo(DETAIL);   // TODO add your handling code here:
    }//GEN-LAST:event_btnExtraDetailMouseClicked

    private void btnRemarkDetailMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRemarkDetailMouseClicked
   loadRemarkInfo(DETAIL);     // TODO add your handling code here:
    }//GEN-LAST:event_btnRemarkDetailMouseClicked

    private void btnRelationDetailMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRelationDetailMouseClicked
  loadRelationInfo(DETAIL);        // TODO add your handling code here:
    }//GEN-LAST:event_btnRelationDetailMouseClicked

    private void btnDeactive1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeactive1MouseClicked
       deactive();  // TODO add your handling code here:
    }//GEN-LAST:event_btnDeactive1MouseClicked
    ...
    private void btnAddMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddMouseDragged
        // TODO add your handling code here:
    }//GEN-LAST:event_btnAddMouseDragged
    ...
    private javax.swing.JLabel btnDeactive1;
    ...
    private javax.swing.JLabel btnExtraDetail;
    private javax.swing.JLabel btnRelationDetail;
    private javax.swing.JLabel btnRemarkDetail;
