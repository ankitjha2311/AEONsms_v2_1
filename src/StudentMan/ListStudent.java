...
public class ListStudent extends javax.swing.JInternalFrame implements UIInterface{
    ...
    public void loadEdit(){
        lebUp.setText("Update Student Detail");
    ...
    private void initComponents() {
        ...
        can.setMinimumSize(new java.awt.Dimension(980, 1195));
        can.setPreferredSize(new java.awt.Dimension(980, 1195));
        ...
        lebUp.setBackground(new java.awt.Color(0, 102, 153));
        lebUp.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        lebUp.setForeground(new java.awt.Color(255, 255, 255));
        lebUp.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lebUp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Student_Male_38px.png"))); // NOI18N
        lebUp.setText("Update Student Details");
        lebUp.setIconTextGap(20);
        lebUp.setOpaque(true);
        can.add(lebUp, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1030, 60));
        ...
        jLabel49.setBackground(new java.awt.Color(0, 102, 0));
        jLabel49.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel49.setForeground(new java.awt.Color(255, 255, 255));
        jLabel49.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel49.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Undo_30px.png"))); // NOI18N
        jLabel49.setText("Back");
        jLabel49.setIconTextGap(9);
        jLabel49.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel49MouseClicked(evt);
            }
        });
        can.add(jLabel49, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 90, 30));
        ...
        jPanel1.setMinimumSize(new java.awt.Dimension(980, 1145));
        jPanel1.setPreferredSize(new java.awt.Dimension(980, 1145));
        ...
        jLabel50.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_Undo_30px.png"))); // NOI18N
        jLabel50.setText("Back");
        jLabel50.setIconTextGap(9);
        jLabel50.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel50MouseClicked(evt);
            }
        });
        jPanel1.add(jLabel50, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 90, 30));

        jScrollPane3.setViewportView(jPanel1);

        detailPanel.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1020, 700));
...
loadExtraInfo(ADD);        // TODO add your handling code here:
  ...
  loadRelationInfo(DETAIL);        // TODO add your handling code here:
    ...
    private javax.swing.JLabel lebUp;
